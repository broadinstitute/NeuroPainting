...
get_skel_features <- function(profiles) 
  profiles %>% select(matches("Metadata_|Skel$"))
...
![](4.branching-analysis_files/figure-gfm/unnamed-chunk-35-1.png)<!-- -->
...
![](4.branching-analysis_files/figure-gfm/unnamed-chunk-36-1.png)<!-- -->
